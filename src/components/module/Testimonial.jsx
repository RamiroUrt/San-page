  ...
  <blockquote className="text-center lg:mx-auto lg:w-3/5">
    <div className="mt-6 lg:mt-10">
      <p className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium text-gray-800">
        ...
        <span className="relative z-10 text-gray-800 text-cont"><b>La salud mental no es un destino, sino un {""}
        <RoughNotationGroup show={show} >
              <RoughNotation type="circle" show={true} color="#FAD4D8" padding={10}>
         proceso
          </RoughNotation>
        </RoughNotationGroup>
         . Se trata de cómo conduces, no de adónde vas.</b></span>
      </p>
    </div>

    <footer className="mt-6 tittle">
      <div className="font-semibold text-gray-800 text-[23px]" >Noam Shpancer</div>
